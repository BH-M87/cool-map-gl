...
const Measure = () => {
    ...
    return <div style={{width:1000,height:500}}>
            <MapGL 
                measureConfig={measureState}
            />
            <div style={{position:'absolute',top:0,left:0,zIndex:10}}>
                <div style={styleBtn} onClick={handleMeasureDistance}>测距</div>
                <div style={styleBtn} onClick={handleMeasureArea}>测面</div>
                <div style={styleBtn} onClick={handleClear}>清除</div>
            </div>
    </div>;
};
