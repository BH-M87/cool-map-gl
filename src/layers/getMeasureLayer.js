...
export const getMeasureLayer = (
    distance,area,
    activeLine,activePolygon,
    geojsonLine,geojsonPolygon,
    featureIndexesLine,featureIndexesPolygon,
    onEditLine,onEditPolygon
)=>{
    const layers = [];
    if(distance){
        layers.push(createMeasureDistanceLayer(activeLine,geojsonLine,featureIndexesLine,onEditLine));
    }
    if(area){
        layers.push(createMeasureAreaLayer(activePolygon,geojsonPolygon,featureIndexesPolygon,onEditPolygon));
    }
    return layers;
}
